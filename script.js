...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (document.getElementById('progressChart')) { // Check if element exists
    ...
    if (document.getElementById('gradeChart')) { // Check if element exists
    ...
    // GPA History Chart
    if (document.getElementById('gpaHistoryChart')) { // Check if element exists
